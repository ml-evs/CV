...
%\usepackage{doi}
\usepackage[style=nature,sorting=ymdnt,defernumbers=false,date=year,sortcites=false,maxnames=5,minnames=2,maxbibnames=5]{biblatex}
...
\section{\texttt{RESEARCH INTEREST}}
\cvitem{}{My background in computational materials science has left me with an overarching interest in the application of artificial intelligence, open source software, and data management infrastructure to accelerate and enhance scientific workflows for discovery in the chemical and materials sciences.}
...
\cvitem{2025--}{\textbf{Leverhulme Trust Early Career Research Fellow}}
\cvitem{}{University of Cambridge, with Prof Dame Clare Grey FRS}
\cvitem{}{
\begin{itemize}
    ...
    \item[--] Extending \emph{datalab} to support additional domains, user workflows and modalities to enable research data management for automated, autonomous and otherwise data-driven labs.
    \item[--] Pushing for interoperability in the chemistry and materials science software \& data ecosystem via \colourhref{https://optimade.org}{OPTIMADE} and community efforts such as \colourhref{https://madices.github.io}{MADICES}.
    %\item[--] Providing targeted technical support for specific projects within the department and beyond.
\end{itemize}}
\vspace{-0.2in}
\cvitem{2024--}{\textbf{Scientific Software Consultant} and \textbf{Director}}
...
\begin{itemize}
    ...
    \item[--] Key stakeholder in projects with partners spanning \colourhref{https://psdi.ac.uk}{PSDI}, \colourhref{https://ccdc.cam.ac.uk}{CCDC}, \colourhref{https://faraday.ac.uk}{Faraday Institution} and \colourhref{https://imperial.ac.uk/digibat}{DIGIBAT}.
    \item[--] Currently converting to a Community Benefit Company aligned around proliferating best practices in data management for accelerated materials and chemistry R\&D.
\end{itemize}}
\vspace{-0.2in}
\cvitem{2020--2025}{\textbf{Research Assistant} (2020--2022) then \textbf{BEWARE Research Fellow} (2022--2025)}
\cvitem{}{IMCN, Universit\'{e} catholique de Louvain and Matgenix SRL., with Prof Gian-Marco Rignanese}
\cvitem{}{
\begin{itemize}
    \item[--] High-throughput machine-learning accelerated workflows for materials discovery and design.
    \item[--] Leading development of the \colourhref{https://optimade.org}{OPTIMADE} API specification and associated software (\colourhref{https://github.com/Materials-Consortia/optimade-python-tools}{\texttt{optimade-python-tools}}, \colourhref{https://github.com/materialscloud-org/optimade-maker}{\texttt{optimade-maker})}.
\end{itemize}}
\vspace{-0.2in}
...
%\cvdoubleitem{Languages}{\textbf{Python}, Javascript, Vue.js, Fortran, C++}{Tools}{\textbf{git}, \textbf{vim}, \textbf{Docker}, \textbf{Ansible}, Terraform}
...
\cvitem{2025}{Leverhulme Trust Early Career Research Fellowship with additional support from Isaac Newton Trust.}
...
\cvitem{2026--}{Guest Lecturer ``Materials research in the AI era'' on the MPhil in Advanced Materials for the Energy Transition, Department of Materials Science \& Metallurgy, University of Cambridge}
\cvitem{2026--}{\colourhref{{https://www.data.cam.ac.uk/data-champions/find?search_api_views_fulltext=evans}}{Data Champion} at the University of Cambridge}
\cvitem{2025--}{Co-organiser of the Research Software Engineering East of England (\colourhref{https://east-england.society-rse.org/organisation/}{RS-Triple-E}) group and events}
\cvitem{2025--}{Co-organiser of the CECAM \emph{OPTIMADE} workshop series, 2025 (Vilnius) and 2026 (Grenoble).}
\cvitem{2025--}{Member of the steering committee for the \colourhref{https://www.ccpnc.ac.uk}{Collaborative Computational Project for NMR Crystallography}.}
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x8), \emph{JOSS} (x7), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x3) (IOP Outstanding Reviewer 2024), \emph{Sci Data} (x2), \emph{npj. Comp. Mater.} (x2), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1), \emph{Physica Scripta} (x1), \emph{Phys. Chem. Chem. Phys.} (x1)}
\cvitem{2022--2025}{Initiator and organiser of the CECAM \colourhref{https://madices.github.io}{MADICES} workshop series in 2022 (virtual), 2024 (Berlin, Germany) and 2025 (Villigen, Switzerland).}
...
\cvitem{2026}{4x Invited seminars: AI4Materials, Henry Royce Institute, Manchester (March); AI4Materials, University of Oxford (April); AI and automation in chemistry, University of Cambridge (April); Advanced Battery Manufacturing Workshop, Cambridge (April)}
%\cvitem{}{Invited talk: AI 4 Materials Symposium, University of Oxford, UK (April 2026)}
%\cvitem{}{Invited talk: Chemical and material sciences enabled by AI and automation Workshop, University of Cambridge, UK (April 2026)}
%\cvitem{}{Invited talk: Advanced Battery Manufacturing Workshop, Cambridge, UK (April 2026)}
\cvitem{}{Upcoming invited talk: Swiss Battery Days, ETH Zurich, Switzerland (August 2026)}
\cvitem{2025}{Invited talk: ML4Spectroscopy, Vrije Universiteit Brussel, Belgium.}
%\cvitem{2025}{Invited talk: \emph{Decentralized materials research data management, curation and dissemination for accelerated discovery}, ML4Spectroscopy, Vrije Universiteit Brussel, Belgium.}
\cvitem{}{4x Invited seminars: \emph{Decentralized materials research data management, curation and dissemination for accelerated discovery}. MMDG, Uni. Birmingham; PSDI Polymer Data Workshop, Loughborough Uni.; Comp. Chem. Seminars, Uni. Warwick; AIChemy Seminars, Imperial College London}
\cvitem{2024}{Invited talk: \emph{Decentralized materials research data management, curation and dissemination for accelerated discovery}, Symposium: Democratizing AI in Materials Science, MRS Fall, Boston, USA}
...
%\cvitem{2023}{Invited talk: \emph{Open Databases Integration for Materials Design} at the CECAM Flagship Workshop for FAIR and TRUE Soft Matter Simulations, Max Planck Institute for Polymer Research, Germany.}
...
Underline indicates (joint) first authorship (reordered where appropriate). $\dagger$ indicates (co-)corresponding authorship. Full list with OA links available online (\colourhref{https://ml-evs.science/papers}{\texttt{https://ml-evs.science/papers}}, \colourhref{https://orcid.org/0000-0002-1182-9098}{ORCID}, \colourhref{https://scholar.google.co.uk/citations?user=3aG55qYAAAAJ&hl=en}{Google Scholar} (950+ citations, h-index 14).
\nocite{*}
\subsection{\hspace{-1in}Preprints}
\printbibliography[heading=none,keyword=inprep]
\vspace{-0.16in}
\subsection{\hspace{-1in}Peer-reviewed articles}
