...
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x8), \emph{JOSS} (x7), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x3) (IOP Outstanding Reviewer 2024), \emph{Sci Data} (x3), \emph{npj. Comp. Mater.} (x2), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1), \emph{Physica Scripta} (x1), \emph{Phys. Chem. Chem. Phys.} (x1)}
