...
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x7), \emph{JOSS} (x6), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x2) (IOP Outstanding Reviewer 2024), \emph{npj. Comp. Mater.} (x1), \emph{Sci Data} (x1), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1), \emph{Physica Scripta} (x1).}
\cvitem{2022--}{Initiator and organiser of the CECAM \colourhref{https://madices.github.io}{MADICES} workshop series.}
\cvitem{2025--}{Co-organiser of the CECAM \emph{OPTIMADE} workshop series, 2025 (Vilnius)}
