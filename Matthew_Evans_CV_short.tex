...
\newcommand{\eprint}[1]{{\greencolourhref{#1}{{#1}}}}
...
\cvitem{}{
\begin{itemize}
    \item[--] Funded by BIG-MAP External Stakeholder Initiative to develop \colourhref{https://github.com/the-grey-group/datalab}{\texttt{datalab}}, a data management platform for tracking samples, devices and associated characterisation.
...
\cvitem{2018--}{Reviewed manuscripts and data for \emph{npj. Comp. Mater.}, \emph{Sci Data} (x1), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Scientific Reports} (x1), \emph{Digital Discovery} (x4) and \emph{Journal of Open Source Software} (x4)}
...
%\pagebreak
\section{\texttt{SELECTED RECENT PUBLICATIONS}}
Underline indicates (joint) first authorship. Full publication list available at \colourhref{https://ml-evs.science/papers}{\texttt{https://ml-evs.science/papers}}.
%\nocite{*}
