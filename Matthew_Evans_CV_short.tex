...
\cvitem{2025--}{\textbf{Leverhulme Early Career Research Fellow}}
...
\cvitem{2025}{Leverhulme Early Career Research Fellowship with additional support from Isaac Newton Trust.}
...
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x7), \emph{JOSS} (x6), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x2) (IOP Outstanding Reviewer 2024), \emph{npj. Comp. Mater.} (x1), \emph{Sci Data} (x1), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1).}
...
\cvitem{2022--2024}{Initiator and organiser of the CECAM Workshop series \emph{Machine-actionable Data Interoperability for Chemical Sciences} (\colourhref{https://madices.github.io/}{MADICES}, February 2022, April 2024 and upcoming in October 2025)}
