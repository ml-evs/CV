...
\cvitem{2018--}{Reviewed for \emph{JOSS} (x6), \emph{Digital Discovery} (x6), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x2) (IOP Outstanding Reviewer 2024), \emph{npj. Comp. Mater.} (x1), \emph{Sci Data} (x1), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1).}
