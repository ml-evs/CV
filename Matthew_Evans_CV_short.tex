...
\cvitem{2025--}{Co-organiser of the Research Software Engineering East of England (\colourhref{https://east-england.society-rse.org/organisation/}{RS-Triple-E}) group}
...
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x7), \emph{JOSS} (x6), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x3) (IOP Outstanding Reviewer 2024), \emph{Sci Data} (x2), \emph{npj. Comp. Mater.} (x1), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1), \emph{Physica Scripta} (x1), \emph{Phys. Chem. Chem. Phys.} (x1)}
...
\cvitem{2026}{Upcoming invited talk: AI4Materials Science Symposium, Henry Royce Institute, UK (March 2026)}
\cvitem{}{Upcoming invited talk: Advanced Battery Manufacturing Workshop, Cambridge UK (April 2026)}
\cvitem{}{Upcoming invited talk: AI and automation workshop, Cambridge UK (April 2026)}
