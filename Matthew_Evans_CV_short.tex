...
\cvitem{}{My background in computational materials science has left me with an overarching interest in the application of machine learning, open source software, and data management infrastructure to accelerate and enhance scientific workflows for discovery in the chemical and materials sciences, in particular for energy storage and conversion applications.}
...
\begin{itemize}
    ...
    \item[--] Key stakeholder in projects with partners spanning \colourhref{https://psdi.ac.uk}{PSDI}, \colourhref{https://ccdc.cam.ac.uk}{CCDC}, \colourhref{https://faraday.ac.uk}{Faraday Institution} and others.
\end{itemize}}
\vspace{-0.2in}
...
\cvitem{2026--}{Guest Lecturer ``Materials research in the AI era'' on the MPhil in Advanced Materials for the Energy Transition at the University of Cambridge}
...
\cvitem{2025--}{Co-organiser of the CECAM \emph{OPTIMADE} workshop series, 2025 (Vilnius, Lithuania) and 2026 (Grenoble, France).}
...
\cvitem{2018--}{Reviewed for \emph{Digital Discovery} (x7), \emph{JOSS} (x6), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Mach. Learn.: Sci. Technol.} (x2) (IOP Outstanding Reviewer 2024), \emph{npj. Comp. Mater.} (x1), \emph{Sci Data} (x2), \emph{Sci. Rep.} (x1), \emph{Sci. Technol. Adv. Mater.: Methods} (x1), \emph{Physica Scripta} (x1), \emph{Phys. Chem. Chem. Phys.} (x1)}
...
\cvitem{2026}{Upcoming invited talk: Henry Royce Institute AI4Materials Science Symposium, University of Manchester, UK (March 2026)}
\cvitem{}{Upcoming invited talk: CHemical and Material Sciences Enabled by AI and automation, Cambridge UK (April 2026)}
\cvitem{}{Upcoming invited talk: Swiss Battery Days, ETH Zurich, Switzerland (August 2026)}
\cvitem{2025}{Invited talk: \emph{Decentralized materials research data management, curation and dissemination for
accelerated discovery}, Machine Learning for Spectroscopy, Vrije Universiteit Brussel, Belgium.}
...
\nocite{*}
\subsection{\hspace{-1in}Preprints/In preparation}
