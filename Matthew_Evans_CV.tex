...
\cvdoubleitem{Data viz}{\textbf{matplotlib}, Bokeh, d3.js, seaborn}{Toolset}{\textbf{git}, \textbf{vim}, Docker}
...
\cvitem{2016--}{Active member of TCM syadmin team, \emph{(Cavendish Laboratory)}.}
...
\cvitem{Upcoming}{\emph{Sn-P anodes for potassium-ion batteries: insights from crystal structure prediction}, Contributed Talk, SMARTER 6, Kemijski Inštitut, Slovenia}
\cvitem{2015--2018}{Presented posters and talks at nearly 20 conferences and workshops both nationally and internationally. Selected works can be found on my \colourhref{ml-evs.github.io/talks.html}{personal website}.}
...
\pagestyle{empty}
%\input{../summer_2k18_internships/ccdc/ccdc_cover_letter}
