...
\cvitem{}{Discovery and computational characterisation of novel high-capacity anode materials for Li-, Na- and K-ion batteries, using \emph{ab initio} random structure searching (AIRSS) and evolutionary approaches, implemented in the open-source \colourhref{http://ilustrado.readthedocs.io}{\texttt{ilustrado}} package. Contributed to the CASTEP and OptaDOS codes. PhD research undertaken as a member of the EPSRC CDT for Computational Methods in Materials Science.}
...
\end{itemize}}
\vspace{-0.2in}
\cvitem{2016--2018}{Demonstrator: Part IB Introduction to Computing (C++), Cavendish Laboratory}
