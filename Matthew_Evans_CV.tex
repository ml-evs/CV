...
\usepackage[paperheight=36in,margin=1in,scale=0.8]{geometry}
...
\begin{itemize}
    ...
    \item[--] Funded by BIG-MAP External Stakeholder Initiative to implement functionality for electrochemical cycling, NMR and XRD data management.
    \item[--] Founded and co-leader of a \colourhref{https://www.marda-alliance.org/}{MaRDA} working group on \colourhref{https://github.com/marda-alliance/metadata_extractors/}{metadata extractors} in materials science and chemistry.
\end{itemize}}
\vspace{-0.2in}
...
\cvdoubleitem{Languages}{\textbf{Python}, Fortran, Cython, C++}{Databases}{\textbf{MongoDB}, SQL, Elasticsearch}
\cvdoubleitem{DFT}{\textbf{CASTEP}, Quantum Espresso, \emph{GPAW}}{Packages}{\textbf{NumPy, SciPy, matplotlib, scikit-learn, FastAPI}, Tensorflow}
