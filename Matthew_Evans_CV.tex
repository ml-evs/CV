...
\usepackage[paperheight=43in,margin=1in,scale=0.8]{geometry}
...
\cvitem{2018--}{Reviewed manuscripts and data for \emph{npj. Computational Materials} (x2), \emph{Scientific Data} (x1), \emph{J. Phys.: Cond. Mat.} (x2), \emph{Scientific Reports} (x1), \emph{Digital Discovery} (x2) and \emph{Journal of Open Source Software} (x4)}
