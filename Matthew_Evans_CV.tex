...
\cvitem{2016--}{Volunteer: Key Stage 2 Code Club \emph{(Ridgefield Primary School, Cambridge)}.}
\cvitem{2016--2017}{Demonstrator: Part IB Computational Physics (C++), \emph{(Cavendish Laboratory)}.}
...
\cvdoubleitem{Platforms}{\textbf{Linux}, \textit{*nix}}{HPC Facilities}{ARCHER (UK), Darwin (Cambridge)}
\cvdoubleitem{Software}{\textbf{vim}, \LaTeX, Inkscape, GIMP}{Utilities}{\textbf{git}, shell scripting, GNU toolchain}
...
\cvitem{2017}{CASTEP Developer Workshop, University of Oxford}
\cvitem{2017}{CASTEP Developer Workshop, University of Oxford}
