...
\cvitem{2018--}{Reviewed manuscripts and data for \emph{npj. Computational Materials} (x2), \emph{Scientific Data} (x1), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Scientific Reports} (x1), \emph{Digital Discovery} (x3) and \emph{Journal of Open Source Software} (x4)}
