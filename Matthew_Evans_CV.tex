...
\usepackage[paperheight=38in,margin=1in,scale=0.8]{geometry}
...
\cvitem{2023}{Invited talk: Open Databases Integration for Materials Design (OPTIMADE) at the Actively Learning Materials Science (AL4MS2023) workshop, Aalto University, Finland.}
\cvitem{}{Invited talk: \emph{Metadata extractors for interoperable ETL}, MaRDA Alliance Annual Meeting}
\cvitem{}{Invited talk: \emph{Interoperable data management for fundamental battery research}, Labatory of Materials Simulatoin, Paul Scherrer Institut, Switzerland.}
