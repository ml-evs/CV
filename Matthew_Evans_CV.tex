...
\cvitem{2018--}{Reviewed manuscripts and data for \emph{npj. Comp. Mater.} (x1), \emph{Sci Data} (x1), \emph{J. Phys.: Cond. Mat.} (x4), \emph{Scientific Reports} (x1), \emph{Digital Discovery} (x4), \emph{Machine Learning: Science \& Technology} (x1), and \emph{Journal of Open Source Software} (x5)}
