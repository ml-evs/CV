...
\cvitem{}{\begin{itemize}
    ...
    \item[--] Active member of the \colourhref{https://optiamde.org}{OPTIMADE consortium} for materials database interoperability and author and maintainer of \colourhref{https://github.com/Materials-Consortia/optimade-python-tools}{\texttt{optimade-python-tools}} packages and \colourhref{https://odbx.science}{\texttt{odbx}} implementation
\end{itemize}}
