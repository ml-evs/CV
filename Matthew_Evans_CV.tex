...
\cventry{2016--}{PhD Physics}{Theory of Condensed Matter Group}{University of Cambridge}{\textit{Expected submission 2019}}{}  % arguments 3 to 6 can be left empty
...
\cvitem{}{Discovery and computational characterisation of novel high-capacity anode materials for Li-, Na- and K-ion batteries, using \emph{ab initio} random structure searching (AIRSS) and evolutionary approaches, implemented in the open-source \colourhref{http://www.tcm.phy.cam.ac.uk/~me388/ilustrado}{\texttt{ilustrado}} package. PhD research undertaken as a member of the EPSRC CDT for Computational Methods in Materials Science.}
