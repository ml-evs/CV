...
\usepackage[paperheight=35in,margin=1in,scale=0.8]{geometry}
...
\end{itemize}}
\vspace{-0.2in}
\cvitem{2020--2022}{\textbf{Researcher}}
...
\cvitem{2018--}{Reviewed manuscripts for \emph{npj. Computational Materials}, \emph{J. Phys.: Cond. Mat.}, \emph{Scientific Reports} and \emph{Journal of Open Source Software}}
