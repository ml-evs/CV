...
%\usepackage{doi}
\usepackage[style=nature,sorting=ymdnt,defernumbers=true,date=year]{biblatex}
...
\cvitem{2016--2020}{\textbf{Crystal structure prediction for next-generation energy storage applications}}
\cvitem{PhD}{with Dr Andrew Morris \emph{(University of Cambridge/University of Birmingham)}}
\cvitem{}{Discovery and computational characterisation of high-capacity conversion anodes for Li-, Na- and K-ion batteries. Author of two open-source Python packages: database approaches for high-throughput calculations and materials design with \colourhref{http://matador.science}{\texttt{matador}} and crystal structure prediction with \colourhref{http://ilustrado.readthedocs.io}{\texttt{ilustrado}}. Contributed to the \colourhref{https://castep.org}{CASTEP} and \colourhref{https://optimade.org}{OptaDOS} codes. Active member of the \colourhref{https://optiamde.org}{OPTIMADE consortium} for materials database interoperation and author and maintainer of \colourhref{https://github.com/Materials-Consortia/optimade-python-tools}{\texttt{optimade-python-tools}} package and \colourhref{https://odbx.science}{\texttt{odbx}} implementation.
...
\cvitem{2019}{\textbf{Scientific Software Developer}}
\cvitem{Internship}{Enthought Inc., Cambridge}
\cvitem{}{Worked on the open source, Horizon 2020 \colourhref{https://github.com/force-h2020}{FORCE project}, with a focus on adding functionality to the workflow manager for multi-criteria optimisations, including developing a Bayesian optimisation plugin. Helped develop Cython bindings for the ACADO toolkit.}
...
\cvitem{2014, 2015}{\textbf{Interactions of quantised vortices in superfluid helium}}
\cvitem{UG}{with Dr Paul Walmsley \& Prof Andrei Golov \emph{(University of Manchester)}}
...
\cvitem{2014--2015}{\textbf{Electronic structure of defects in graphene superlattices}}
\cvitem{MPhys}{with Prof Francisco Guinea \emph{(University of Manchester)}}
...
\cvitem{2013}{\textbf{Hard sphere packing of nanotube-encapsulated fullerenes}}
\cvitem{UG}{with Dr Ho-Kei Chan \& Prof Elena Besley \emph{(University of Nottingham)}}
...
\cvdoubleitem{DFT}{\textbf{CASTEP}, Quantum Espresso, GPAW}{Packages}{\textbf{NumPy, SciPy, matplotlib}, scikit-learn}
...
\cvitem{2016--}{Demonstrator: 4x at annual CASTEP workshop, University of Oxford}
...
\cvitem{2020}{Invited talk and demonstration: \emph{\texttt{odbx \& OPTIMADE}} and \emph{\texttt{optimade-python-tools}}, CECAM Workshop, Open Databases Integration for Materials Design 2020}
