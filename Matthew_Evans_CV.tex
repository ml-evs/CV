...
%\usepackage{doi}
\usepackage[style=nature,sorting=ymdnt,defernumbers=true,date=year,sortcites=true]{biblatex}
...
\cvitem{2020--}{\textbf{Postdoctoral Researcher}}
...
\begin{itemize}
    ...
    \item[--] Continuing work on the OPTIMADE API,
...
\cvitem{}{\begin{itemize}
    \item[--] Computional materials Discovery for conversion anodes for Li, Na and K-ion batteries \cite{NaP, KP, CuP, JM}
    \item[--] Author of two open-source Python packages: database approaches for high-throughput calculations and materials design with \colourhref{http://matador.science}{\texttt{matador}} \cite{matador} and crystal structure prediction with \colourhref{http://ilustrado.readthedocs.io}{\texttt{ilustrado}}.
    \item[--] Contributed to the \colourhref{https://castep.org}{CASTEP} and \colourhref{https://optimade.org}{OptaDOS} codes.
    \item[--] Active member of the \colourhref{https://optiamde.org}{OPTIMADE consortium} for materials database interoperation \cite{optimade} and author and maintainer of \colourhref{https://github.com/Materials-Consortia/optimade-python-tools}{\texttt{optimade-python-tools}} package \cite{optimade-python-tools} and \colourhref{https://odbx.science}{\texttt{odbx}} implementation.
\end{itemize}}
...
\cvitem{}{Worked on the open source, Horizon 2020 \colourhref{https://github.com/force-h2020}{FORCE project}, with a focus on adding functionality to the workflow manager for multi-criteria optimisations.
, including developing a Bayesian optimisation plugin. Helped develop Cython bindings for the ACADO toolkit.}
