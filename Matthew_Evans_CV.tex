...
\cvitem{}{Discovery and computational characterisation of novel high-capacity anode materials for Li-, Na- and K-ion batteries. Author of two open-source Python packages: database approaches for high-throughput calculations and materials design with \colourhref{http://matador.science}{\texttt{matador}} and crystal structure prediction with \colourhref{http://ilustrado.readthedocs.io}{\texttt{ilustrado}} package. Contributed to the CASTEP and OptaDOS codes. Active member of the OPTiMaDe consortium for materials database interoperation. PhD research undertaken as a member of the EPSRC CDT for Computational Methods in Materials Science.}
...
\cvdoubleitem{DFT}{\textbf{CASTEP}, Quantum Espresso, GPAW}{Packages}{\textbf{NumPy, SciPy}, spglib, scikit-learn}
\cvdoubleitem{Tools}{\textbf{git}, \textbf{vim}, \textit{Docker}}{Practices}{\textbf{Test-driven development, CI}}
