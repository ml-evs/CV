...
\cventry{2016--}{PhD Physics}{Theory of Condensed Matter Group}{University of Cambridge}{\textit{expected 2019}}{}  % arguments 3 to 6 can be left empty
...
\cvdoubleitem{DFT}{\textbf{CASTEP}, Quantum Espresso, GPAW}{Packages}{\textbf{NumPy, spglib, scikit-learn}}
\cvdoubleitem{Platforms}{\textbf{Linux}, \textit{*nix}}{Practices}{\textbf{Test-driven development, CI}}
\cvdoubleitem{Data viz}{\textbf{matplotlib}, Bokeh, d3.js}{Tools}{\textbf{git}, \textbf{vim}, Docker}

\section{\texttt{(TEACHING + SERVICE)}}
\cvitem{2018--}{Organiser of fortnightly computational physics talk series, \emph{(CDT for Computational Materials Science)}.}
\cvitem{2018--}{Reviewed manuscripts of \emph{Scientific Reports}.}
\cvitem{2016--}{Active member of TCM \texttt{sysadmin} team, \emph{(Cavendish Laboratory)}.}
\cvitem{2018}{Demonstrator: Graduate-level Atomistic Modelling of Materials, \emph{(Cavendish Laboratory)}.}
...
\cvitem{2015--2018}{Presented posters and talks at 20 conferences and workshops both nationally and internationally. Selected works can be found on my \colourhref{ml-evs.github.io/talks.html}{personal website}.}
\cvitem{2018}{\emph{Sn-P anodes for potassium-ion batteries: insights from crystal structure prediction}, Contributed Talk, SMARTER6, Ljubljana, Slovenia}
\cvitem{2018}{\emph{\texttt{matador}: databases and crystal structure prediction} (\colourhref{http://www.tcm.phy.cam.ac.uk/~me388/optimade/matador_optimade.pdf}{slides}), Invited Talk, OPTiMaDe workshop, CECAM@EPFL, Switzerland}
\cvitem{}{HPC Midlands+ Substantial Project: awarded 1.3 MCPUh for \emph{High-throughput materials discovery for energy applications}, M. L. Evans and A. J. Morris.}
...
\cvitem{}{Tier-2 Resource Allocation: awarded 4 MCPUh for \emph{Ab initio structure prediction for next-generation battery materials}, B. Karasulu, M. L. Evans and A. J. Morris.}
