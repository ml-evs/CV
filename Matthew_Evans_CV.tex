...
\cvdoubleitem{Languages}{\textbf{Python}, Fortran, C++}{Databases}{\textbf{MongoDB}, \textit{SQL}}
\cvdoubleitem{DFT}{\textbf{CASTEP}, Quantum Espresso, ASE, GPAW}{Packages}{\textbf{NumPy, spglib, scikit-learn}}
